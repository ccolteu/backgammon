...
import com.cc.backgammon.theme.Parchment
...
enum class BoardStyle(
  ...
  OAK_CHARCOAL(
    label = "Oak charcoal",
    drawable = R.drawable.board_oak_charcoal,
  ...
  companion object {
    fun fromStorage(raw: String?): BoardStyle = entries.find { it.name == raw } ?: OAK_CHARCOAL
  }
}
